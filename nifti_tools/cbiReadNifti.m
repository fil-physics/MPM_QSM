...
%commented out: SR   data=data.*hdr.scl_slope+hdr.scl_inter;
%   begin mod: SR: don't need to multiply if the intercept == 0 and the slope == 1 - needs double the memory
  if not(hdr.scl_slope==1 && hdr.scl_inter==0)
