...
%
function reslice_inv_nii(old_fn, new_fn, voxel_size, verbose, bg, method, img_idx, preferredForm)
...
%%% BKD START - applying inverse affine transform
